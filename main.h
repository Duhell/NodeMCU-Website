...
<body>
    <header id="head" class="mt-6 flex flex-col items-center">
        ...
        <a href="#head">
            <svg class="fixed bottom-[60px] right-[60px]" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-up-square-fill" viewBox="0 0 16 16">
    ...
    <main class="md:px-32 px-3 ">
        ...
        <div class="mx-auto mt-14 flex flex-col container flex rounded-lg overflow-hidden">
            <div class="px-4  pb-8 pt-4 text-center">
                ...
                <p class="mt-3 text-xl">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto, fugiat reiciendis unde sunt necessitatibus laudantium doloribus aspernatur! Laboriosam velit modi officia ut eligendi suscipit sint, sapiente voluptatum non atque excepturi?
                </p>
            </div>
        </div>
        <section class="container mx-auto mt-16 ">
            <div id="kym" class="flex flex-col space-y-12">
                <div
                        ...
                        <div class=" mt-4 flex md:flex-row flex-col items-center space-x-5" x-data="{open: false}">
                            ...
                            <div x-transition x-show="open" class="flex  space-x-3 mt-3 duration-600  mt-4 md:mt-0 ">
                                ...
                                <a href="www.facebook.com/KymAlcansadoApe" target="_blank">
                                    <svg class="text-blue-800 hover:w-[30px]" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
